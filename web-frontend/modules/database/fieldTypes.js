...
import FieldRatingSubForm from '@jadawel/modules/database/components/field/FieldRatingSubForm'
import FieldTextSubForm from '@jadawel/modules/database/components/field/FieldTextSubForm'
import FieldLongTextSubForm from '@jadawel/modules/database/components/field/FieldLongTextSubForm'
import FieldDateSubForm from '@jadawel/modules/database/components/field/FieldDateSubForm'
import FieldLinkRowSubForm from '@jadawel/modules/database/components/field/FieldLinkRowSubForm'
import FieldMultipleSelectOptionsSubForm from '@jadawel/modules/database/components/field/FieldMultipleSelectOptionsSubForm'
import FieldSingleSelectOptionsSubForm from '@jadawel/modules/database/components/field/FieldSingleSelectOptionsSubForm'
import FieldCollaboratorSubForm from '@jadawel/modules/database/components/field/FieldCollaboratorSubForm'
import FieldPasswordSubForm from '@jadawel/modules/database/components/field/FieldPasswordSubForm'
import FieldBooleanSubForm from '@jadawel/modules/database/components/field/FieldBooleanSubForm'
...
import GridViewFieldEmail from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldEmail'
import GridViewFieldLinkRow from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldLinkRow'
import GridViewFieldNumber from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldNumber'
import GridViewFieldRating from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldRating'
import GridViewFieldBoolean from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldBoolean'
import GridViewFieldDate from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldDate'
import GridViewFieldDateReadOnly from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldDateReadOnly'
import GridViewFieldFile from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldFile'
import GridViewFieldSingleSelect from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldSingleSelect'
import GridViewFieldMultipleSelect from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldMultipleSelect'
import GridViewFieldPhoneNumber from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldPhoneNumber'
import GridViewFieldDuration from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldDuration'
import GridViewFieldMultipleCollaborators from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldMultipleCollaborators'
import GridViewFieldUUID from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldUUID'
import GridViewFieldAutonumber from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldAutonumber'
import GridViewFieldLastModifiedBy from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldLastModifiedBy'
import GridViewFieldPassword from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldPassword'
import GridViewFieldFormViewEditRow from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldFormViewEditRow'

import FunctionalGridViewFieldText from '@jadawel/modules/database/components/view/grid/fields/FunctionalGridViewFieldText'
import FunctionalGridViewFieldDuration from '@jadawel/modules/database/components/view/grid/fields/FunctionalGridViewFieldDuration'
...
import FunctionalGridViewFieldLinkRow from '@jadawel/modules/database/components/view/grid/fields/FunctionalGridViewFieldLinkRow'
...
import FunctionalGridViewFieldRating from '@jadawel/modules/database/components/view/grid/fields/FunctionalGridViewFieldRating'
...
import FunctionalGridViewFieldFile from '@jadawel/modules/database/components/view/grid/fields/FunctionalGridViewFieldFile'
import FunctionalGridViewFieldSingleSelect from '@jadawel/modules/database/components/view/grid/fields/FunctionalGridViewFieldSingleSelect'
import FunctionalGridViewFieldMultipleSelect from '@jadawel/modules/database/components/view/grid/fields/FunctionalGridViewFieldMultipleSelect'
import FunctionalGridViewFieldFormula from '@jadawel/modules/database/components/view/grid/fields/FunctionalGridViewFieldFormula'
import FunctionalGridViewFieldMultipleCollaborators from '@jadawel/modules/database/components/view/grid/fields/FunctionalGridViewFieldMultipleCollaborators'
import FunctionalGridViewFieldURL from '@jadawel/modules/database/components/view/grid/fields/FunctionalGridViewFieldURL'
import FunctionalGridViewFieldUUID from '@jadawel/modules/database/components/view/grid/fields/FunctionalGridViewFieldUUID'
import FunctionalGridViewFieldAutonumber from '@jadawel/modules/database/components/view/grid/fields/FunctionalGridViewFieldAutonumber'
import FunctionalGridViewFieldLastModifiedBy from '@jadawel/modules/database/components/view/grid/fields/FunctionalGridViewFieldLastModifiedBy'
import FunctionalGridVIewFieldPassword from '@jadawel/modules/database/components/view/grid/fields/FunctionalGridVIewFieldPassword.vue'
import FunctionalGridViewFieldFormViewEditRow from '@jadawel/modules/database/components/view/grid/fields/FunctionalGridViewFieldFormViewEditRow'
...
import RowEditFieldEmail from '@jadawel/modules/database/components/row/RowEditFieldEmail'
import RowEditFieldLinkRow from '@jadawel/modules/database/components/row/RowEditFieldLinkRow'
import RowEditFieldNumber from '@jadawel/modules/database/components/row/RowEditFieldNumber'
import RowEditFieldDuration from '@jadawel/modules/database/components/row/RowEditFieldDuration'
import RowEditFieldRating from '@jadawel/modules/database/components/row/RowEditFieldRating'
import RowEditFieldBoolean from '@jadawel/modules/database/components/row/RowEditFieldBoolean'
import RowEditFieldDate from '@jadawel/modules/database/components/row/RowEditFieldDate'
import RowEditFieldDateReadOnly from '@jadawel/modules/database/components/row/RowEditFieldDateReadOnly'
import RowEditFieldFile from '@jadawel/modules/database/components/row/RowEditFieldFile'
...
import RowEditFieldPhoneNumber from '@jadawel/modules/database/components/row/RowEditFieldPhoneNumber'
import RowEditFieldMultipleCollaborators from '@jadawel/modules/database/components/row/RowEditFieldMultipleCollaborators'
import RowEditFieldUUID from '@jadawel/modules/database/components/row/RowEditFieldUUID'
import RowEditFieldAutonumber from '@jadawel/modules/database/components/row/RowEditFieldAutonumber'
import RowEditFieldLastModifiedBy from '@jadawel/modules/database/components/row/RowEditFieldLastModifiedBy'
import RowEditFieldPassword from '@jadawel/modules/database/components/row/RowEditFieldPassword'
import RowEditFieldFormViewEditRow from '@jadawel/modules/database/components/row/RowEditFieldFormViewEditRow'

import RowCardFieldBoolean from '@jadawel/modules/database/components/card/RowCardFieldBoolean'
import RowCardFieldDate from '@jadawel/modules/database/components/card/RowCardFieldDate'
import RowCardFieldDuration from '@jadawel/modules/database/components/card/RowCardFieldDuration'
import RowCardFieldEmail from '@jadawel/modules/database/components/card/RowCardFieldEmail'
...
import RowCardFieldPhoneNumber from '@jadawel/modules/database/components/card/RowCardFieldPhoneNumber'
import RowCardFieldSingleSelect from '@jadawel/modules/database/components/card/RowCardFieldSingleSelect'
import RowCardFieldText from '@jadawel/modules/database/components/card/RowCardFieldText'
...
import RowCardFieldMultipleCollaborators from '@jadawel/modules/database/components/card/RowCardFieldMultipleCollaborators'
import RowCardFieldUUID from '@jadawel/modules/database/components/card/RowCardFieldUUID'
import RowCardFieldAutonumber from '@jadawel/modules/database/components/card/RowCardFieldAutonumber'
import RowCardFieldLastModifiedBy from '@jadawel/modules/database/components/card/RowCardFieldLastModifiedBy'
import RowCardFieldPassword from '@jadawel/modules/database/components/card/RowCardFieldPassword'
import RowCardFieldFormViewEditRow from '@jadawel/modules/database/components/card/RowCardFieldFormViewEditRow'

import RowHistoryFieldText from '@jadawel/modules/database/components/row/RowHistoryFieldText'
import RowHistoryFieldRichText from '@jadawel/modules/database/components/row/RowHistoryFieldRichText'
import RowHistoryFieldDate from '@jadawel/modules/database/components/row/RowHistoryFieldDate'
import RowHistoryFieldNumber from '@jadawel/modules/database/components/row/RowHistoryFieldNumber'
import RowHistoryFieldDuration from '@jadawel/modules/database/components/row/RowHistoryFieldDuration'
import RowHistoryFieldMultipleCollaborators from '@jadawel/modules/database/components/row/RowHistoryFieldMultipleCollaborators'
import RowHistoryFieldFile from '@jadawel/modules/database/components/row/RowHistoryFieldFile'
import RowHistoryFieldMultipleSelect from '@jadawel/modules/database/components/row/RowHistoryFieldMultipleSelect'
import RowHistoryFieldSingleSelect from '@jadawel/modules/database/components/row/RowHistoryFieldSingleSelect'
import RowHistoryFieldBoolean from '@jadawel/modules/database/components/row/RowHistoryFieldBoolean'
import RowHistoryFieldLinkRow from '@jadawel/modules/database/components/row/RowHistoryFieldLinkRow'
import RowHistoryFieldPassword from '@jadawel/modules/database/components/row/RowHistoryFieldPassword'

import FormViewFieldLinkRow from '@jadawel/modules/database/components/view/form/FormViewFieldLinkRow'
import FormViewFieldMultipleLinkRow from '@jadawel/modules/database/components/view/form/FormViewFieldMultipleLinkRow'
import FormViewFieldMultipleSelectCheckboxes from '@jadawel/modules/database/components/view/form/FormViewFieldMultipleSelectCheckboxes'
import FormViewFieldMultipleCollaboratorsCheckboxes from '@jadawel/modules/database/components/view/form/FormViewFieldMultipleCollaboratorsCheckboxes'
import FormViewFieldSingleSelectRadios from '@jadawel/modules/database/components/view/form/FormViewFieldSingleSelectRadios'
...
import GridViewFieldFormula from '@jadawel/modules/database/components/view/grid/fields/GridViewFieldFormula'
import FieldFormulaSubForm from '@jadawel/modules/database/components/field/FieldFormulaSubForm'
import FieldLookupSubForm from '@jadawel/modules/database/components/field/FieldLookupSubForm'
import FieldCountSubForm from '@jadawel/modules/database/components/field/FieldCountSubForm'
import FieldRollupSubForm from '@jadawel/modules/database/components/field/FieldRollupSubForm'
import RowEditFieldFormula from '@jadawel/modules/database/components/row/RowEditFieldFormula'
import {
...
import ViewFilterTypeNumber from '@jadawel/modules/database/components/view/ViewFilterTypeNumber.vue'
import ViewFilterTypeDuration from '@jadawel/modules/database/components/view/ViewFilterTypeDuration.vue'
import FormViewFieldOptionsAllowedSelectOptions from '@jadawel/modules/database/components/view/form/FormViewFieldOptionsAllowedSelectOptions'
import FieldFormViewEditRowSubForm from '@jadawel/modules/database/components/field/FieldFormViewEditRowSubForm'
...
export class FileFieldType extends FieldType {
  ...
  getDocsResponseExample() {
    return [
      {
        url: 'https://files.example.com/user_files/VXotniBOVm8tbstZkKsMKbj2Qg7KmPvn_39d354a76abe56baaf569ad87d0333f58ee4bf3eed368e3b9dc736fd18b09dfd.png',
        thumbnails: {
          tiny: {
            url: 'https://files.example.com/media/thumbnails/tiny/VXotniBOVm8tbstZkKsMKbj2Qg7KmPvn_39d354a76abe56baaf569ad87d0333f58ee4bf3eed368e3b9dc736fd18b09dfd.png',
            width: 21,
            height: 21,
          },
          small: {
            url: 'https://files.example.com/media/thumbnails/small/VXotniBOVm8tbstZkKsMKbj2Qg7KmPvn_39d354a76abe56baaf569ad87d0333f58ee4bf3eed368e3b9dc736fd18b09dfd.png',
            width: 48,
            height: 48,
          },
        },
