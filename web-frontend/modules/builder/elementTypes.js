...
import TextElement from '@jadawel/modules/builder/components/elements/components/TextElement'
import HeadingElement from '@jadawel/modules/builder/components/elements/components/HeadingElement'
import LinkElement from '@jadawel/modules/builder/components/elements/components/LinkElement'
import TextElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/TextElementForm'
import HeadingElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/HeadingElementForm'
import LinkElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/LinkElementForm'
import ImageElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/ImageElementForm'
import ImageElement from '@jadawel/modules/builder/components/elements/components/ImageElement'
import InputTextElement from '@jadawel/modules/builder/components/elements/components/InputTextElement'
import InputTextElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/InputTextElementForm'
import TableElement from '@jadawel/modules/builder/components/elements/components/TableElement'
import TableElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/TableElementForm'
import {
  ensureArray,
  ensureBoolean,
  ensureNumeric,
...
import ColumnElement from '@jadawel/modules/builder/components/elements/components/ColumnElement'
import ColumnElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/ColumnElementForm'
import DefaultStyleForm from '@jadawel/modules/builder/components/elements/components/forms/style/DefaultStyleForm'
import ButtonElement from '@jadawel/modules/builder/components/elements/components/ButtonElement'
import ButtonElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/ButtonElementForm'
import { ClickEvent, SubmitEvent } from '@jadawel/modules/builder/eventTypes'
...
import FormContainerElement from '@jadawel/modules/builder/components/elements/components/FormContainerElement.vue'
import FormContainerElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/FormContainerElementForm.vue'
import SimpleContainerElement from '@jadawel/modules/builder/components/elements/components/SimpleContainerElement.vue'
import SimpleContainerElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/SimpleContainerElementForm.vue'
import ChoiceElement from '@jadawel/modules/builder/components/elements/components/ChoiceElement.vue'
import ChoiceElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/ChoiceElementForm.vue'
import CheckboxElement from '@jadawel/modules/builder/components/elements/components/CheckboxElement.vue'
import CheckboxElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/CheckboxElementForm.vue'
import IFrameElement from '@jadawel/modules/builder/components/elements/components/IFrameElement.vue'
import IFrameElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/IFrameElementForm.vue'
import RepeatElement from '@jadawel/modules/builder/components/elements/components/RepeatElement'
import RepeatElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/RepeatElementForm'
import RecordSelectorElement from '@jadawel/modules/builder/components/elements/components/RecordSelectorElement.vue'
import RecordSelectorElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/RecordSelectorElementForm'
import MultiPageContainerElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/MultiPageContainerElementForm'
import MultiPageContainerElement from '@jadawel/modules/builder/components/elements/components/MultiPageContainerElement'
import DateTimePickerElement from '@jadawel/modules/builder/components/elements/components/DateTimePickerElement'
import DateTimePickerElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/DateTimePickerElementForm'
import MenuElement from '@jadawel/modules/builder/components/elements/components/MenuElement'
import MenuElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/MenuElementForm'
...
} from '@jadawel/modules/builder/elementTypeMixins'
import { isNumeric, isValidEmail } from '@jadawel/modules/core/utils/string'
...
import RatingElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/RatingElementForm'
import RatingElement from '@jadawel/modules/builder/components/elements/components/RatingElement.vue'
import RatingInputElement from '@jadawel/modules/builder/components/elements/components/RatingInputElement.vue'
import RatingInputElementForm from '@jadawel/modules/builder/components/elements/components/forms/general/RatingInputElementForm.vue'

// Images for element modal
import elementImageButton from '@jadawel/modules/builder/assets/icons/element-button.svg?url'
import elementImageChoice from '@jadawel/modules/builder/assets/icons/element-choice.svg?url'
import elementImageCheckbox from '@jadawel/modules/builder/assets/icons/element-checkbox.svg?url'
import elementImageColumn from '@jadawel/modules/builder/assets/icons/element-column.svg?url'
import elementImageDatetimePicker from '@jadawel/modules/builder/assets/icons/element-datetime_picker.svg?url'
import elementImageFooter from '@jadawel/modules/builder/assets/icons/element-footer.svg?url'
import elementImageFormContainer from '@jadawel/modules/builder/assets/icons/element-form_container.svg?url'
import elementImageHeader from '@jadawel/modules/builder/assets/icons/element-header.svg?url'
import elementImageHeading from '@jadawel/modules/builder/assets/icons/element-heading.svg?url'
import elementImageIFrame from '@jadawel/modules/builder/assets/icons/element-iframe.svg?url'
import elementImageImage from '@jadawel/modules/builder/assets/icons/element-image.svg?url'
import elementImageInputText from '@jadawel/modules/builder/assets/icons/element-input_text.svg?url'
import elementImageLink from '@jadawel/modules/builder/assets/icons/element-link.svg?url'
import elementImageMenu from '@jadawel/modules/builder/assets/icons/element-menu.svg?url'
import elementImageRatingInput from '@jadawel/modules/builder/assets/icons/element-rating_input.svg?url'
import elementImageRating from '@jadawel/modules/builder/assets/icons/element-rating.svg?url'
import elementImageRecordSelector from '@jadawel/modules/builder/assets/icons/element-record_selector.svg?url'
import elementImageRepeat from '@jadawel/modules/builder/assets/icons/element-repeat.svg?url'
import elementImageSimpleContainer from '@jadawel/modules/builder/assets/icons/element-simple_container.svg?url'
import elementImageTable from '@jadawel/modules/builder/assets/icons/element-table.svg?url'
import elementImageText from '@jadawel/modules/builder/assets/icons/element-text.svg?url'
