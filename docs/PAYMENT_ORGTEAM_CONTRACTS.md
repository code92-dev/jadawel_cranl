...
support ADMIN, MEMBER, and read-only VIEWER enforcement, including per-member
...
denied when the optional public-view policy reports a suspended or restricted
organization. Any necessary core patch is narrow and documented in PATCHES.md.
