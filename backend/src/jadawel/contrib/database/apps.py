...
from jadawel.contrib.database.fields.utils.pg_datetime import pg_init
from jadawel.contrib.database.table.cache import clear_generated_model_cache
from jadawel.contrib.database.table.operations import RestoreDatabaseTableOperationType
...
from jadawel.core.usage.registries import workspace_storage_usage_item_registry
from jadawel.ws.registries import page_registry


class DatabaseConfig(AppConfig):
    name = "jadawel.contrib.database"
    ...
    def ready(self):
        ...
        from jadawel.contrib.database.tokens.actions import (
        ...
        from jadawel.contrib.database.webhooks.actions import (
        ...
        from jadawel.contrib.database.data_sync.actions import (
        ...
        from jadawel.contrib.database.views.usage_types import (
        ...
        from jadawel.core.registries import subject_type_registry

        from .tokens.subjects import TokenSubjectType

        subject_type_registry.register(TokenSubjectType())

        from jadawel.contrib.database.data_providers.registries import (
        ...
        # notification_types
        from jadawel.contrib.database.fields.notification_types import (
            CollaboratorAddedToRowNotificationType,
            UserMentionInRichTextFieldNotificationType,
        )
        from jadawel.contrib.database.views.notification_types import (
            FormSubmittedNotificationType,
        )
        from jadawel.contrib.database.webhooks.notification_types import (
        ...
        from jadawel.contrib.database.mcp.fields.tools import (
            CreateFieldsMcpTool,
            DeleteFieldsMcpTool,
            UpdateFieldsMcpTool,
        )
        from jadawel.contrib.database.mcp.rows.tools import (
            CreateRowsMcpTool,
            DeleteRowsMcpTool,
            ListRowsMcpTool,
            UpdateRowsMcpTool,
        )
        from jadawel.contrib.database.mcp.table.tools import (
        ...
        from jadawel.contrib.database.rows.history_providers import (
        ...
        from jadawel.contrib.database.rows.registries import (
        ...
        from jadawel.contrib.database.field_rules.actions import (
            CreateFieldRuleActionType,
            DeleteFieldRuleActionType,
            UpdateFieldRuleActionType,
        )
        from jadawel.contrib.database.field_rules.operations import (
        ...
        from jadawel.contrib.database.ws.public.rows.view_realtime_rows import (
            PublicViewRealtimeRowsType,
        )
        from jadawel.contrib.database.ws.views.rows.registries import (
        ...
        import jadawel.contrib.database.data_sync.signals  # noqa: F403, F401
        import jadawel.contrib.database.ws.signals  # noqa: F403, F401

        post_migrate.connect(safely_update_formula_versions, sender=self)
        pre_migrate.connect(clear_generated_model_cache_receiver, sender=self)

        import jadawel.contrib.database.field_rules.receivers  # noqa: F401
        import jadawel.contrib.database.field_rules.signals  # noqa: F401
        import jadawel.contrib.database.fields.receivers  # noqa: F401
        import jadawel.contrib.database.fields.tasks  # noqa: F401
        import jadawel.contrib.database.rows.history  # noqa: F401
        import jadawel.contrib.database.rows.tasks  # noqa: F401
        import jadawel.contrib.database.search.receivers  # noqa: F403, F401
        import jadawel.contrib.database.search.tasks  # noqa: F401
        import jadawel.contrib.database.table.receivers  # noqa: F401
        import jadawel.contrib.database.tokens.receivers  # noqa: F401
        import jadawel.contrib.database.views.receivers  # noqa: F401
        import jadawel.contrib.database.views.tasks  # noqa: F401
...
def safely_update_formula_versions(sender, **kwargs):
    ...
    if apps is not None and not settings.DONT_UPDATE_FORMULAS_AFTER_MIGRATION:
        ...
        from jadawel.contrib.database.formula.migrations.handler import (
