...
from jadawel.contrib.database.fields.constants import UPSERT_OPTION_DICT_KEY
from jadawel.contrib.database.fields.field_sortings import OptionallyAnnotatedOrderBy
...
from jadawel.contrib.database.views.utils import AnnotatedAggregation
...
if TYPE_CHECKING:
    from jadawel.contrib.database.fields.dependencies.handler import FieldDependants
...
class FieldType(
    ...
    Example:
        ...
        from jadawel.contrib.database.fields.registry import (
    ...
    def from_jadawel_formula_type(self, formula_type) -> Field:
        ...
        :return: A Jadawel Field Type model instance that represents this formula type.
        """
...
class FieldTypeRegistry(
    ...
    type is an abstraction made specifically for Jadawel. If added to the registry a
...
# throughout the whole Jadawel application to add a new field type.
