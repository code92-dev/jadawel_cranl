...
from jadawel.core.psycopg import is_psycopg3

if typing.TYPE_CHECKING:
    from jadawel.contrib.database.fields.models import DurationField
...
def format_duration_value(
    ...
    (`jadawel.core.duration.format_value_with_duration_format`), which is the
