...
from jadawel.config.settings.utils import str_to_bool, try_int
from jadawel.contrib.database.api.views.utils import serialize_group_by_data_pages
from jadawel.contrib.database.fields.exceptions import OrderByFieldNotFound
...
from jadawel.contrib.database.views.constants import (
...
def parse_adhoc_view_group_bys(
    ...
    for raw_entry in split_comma_separated_string(raw_group_by):
        ...
        if len(group_bys) > MAX_GROUP_BYS:
