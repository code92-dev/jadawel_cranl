...
from jadawel.contrib.database.fields.models import Field, SelectOption
...
from jadawel.core.utils import get_model_reference_field_name
...
class FormView(View):
    ...
    def active_field_options(self):
        from jadawel.contrib.database.views.handler import CoreHandler
