...
from jadawel.contrib.database.api.utils import get_include_exclude_field_ids
...
from jadawel.contrib.database.search.handler import SearchMode
...
from jadawel.contrib.database.views.view_filter_groups import ViewGroupedFiltersAdapter
from jadawel.core.db import specific_iterator, sql, transaction_atomic
...
class ViewIndexingHandler(metaclass=jadawel_trace_methods(tracer)):
    ...
    def schedule_index_update(cls, view: View):
        ...
        from jadawel.contrib.database.views.tasks import schedule_view_index_update
