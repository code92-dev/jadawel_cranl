...
from jadawel.contrib.database.fields.field_filters import OptionallyAnnotatedQ
...
class ViewType(
    ...
    Example:
        ...
        from jadawel.contrib.database.views.registry import ViewType, view_type_registry
    ...
    def import_serialized(
        ...
        if "database_views" not in id_mapping:
            ...
            # `src/jadawel/contrib/database/table/handler.py::duplicate_table`
    ...
    def _import_default_row_values(
        ...
        from jadawel.contrib.database.views.models import ViewDefaultValue
    ...
    def get_field_options_serializer_class(
        ...
        from jadawel.contrib.database.api.views.serializers import FieldOptionsField
...
class ViewTypeRegistry(
    ...
    is an abstraction made specifically for Jadawel. If added to the registry a user can
...
class ViewFilterType(Instance):
    ...
    Example:
        from jadawel.contrib.database.views.registry import (
...
# throughout the whole Jadawel application to add a new view type.
