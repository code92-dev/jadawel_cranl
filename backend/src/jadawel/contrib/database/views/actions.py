...
from jadawel.contrib.database.action.scopes import (
    TABLE_ACTION_CONTEXT,
    VIEW_ACTION_CONTEXT,
    TableActionScopeType,
    ViewActionScopeType,
)
from jadawel.contrib.database.fields.exceptions import FieldDoesNotExist
from jadawel.contrib.database.fields.handler import FieldHandler
from jadawel.contrib.database.fields.models import Field
from jadawel.contrib.database.rows.exceptions import CannotCreateRowsInTable
from jadawel.contrib.database.rows.helpers import (
    construct_entry_from_action_and_diff,
    construct_related_rows_entries,
    extract_row_diff,
    update_related_tables_entries,
)
from jadawel.contrib.database.rows.models import RowHistory
from jadawel.contrib.database.rows.types import (
    ActionData,
    RelatedRowsDiff,
    RowChangeDiff,
)
...
from jadawel.contrib.database.views.handler import FieldOptionsDict, ViewHandler
...
from jadawel.contrib.database.views.utils import serialize_row_for_action
from jadawel.core.action.models import Action
...
from jadawel.core.action.signals import ActionCommandType
...
class CreateViewFilterActionType(UndoableActionType):
    ...
    def do(
        ...
        See jadawel.contrib.database.views.handler.ViewHandler.create_filter
...
class UpdateViewFilterActionType(UndoableActionType):
    ...
    def do(
        ...
        See jadawel.contrib.database.views.handler.ViewHandler.update_filter
...
class DeleteViewFilterActionType(UndoableActionType):
    ...
    def do(
        ...
        See jadawel.contrib.database.views.handler.ViewHandler.delete_filter
...
class CreateViewFilterGroupActionType(UndoableActionType):
    ...
    def do(
        ...
        jadawel.contrib.database.views.handler.ViewHandler.create_filter_group
...
class UpdateViewFilterGroupActionType(UndoableActionType):
    ...
    def do(
        ...
        jadawel.contrib.database.views.handler.ViewHandler.update_filter_group
...
class DeleteViewFilterGroupActionType(UndoableActionType):
    ...
    def do(
        ...
        jadawel.contrib.database.views.handler.ViewHandler.delete_filter_group
...
class CreateViewSortActionType(UndoableActionType):
    ...
    def do(
        ...
        See jadawel.contrib.database.views.handler.ViewHandler.create_sort
...
class UpdateViewSortActionType(UndoableActionType):
    ...
    def do(
        ...
        See jadawel.contrib.database.views.handler.ViewHandler.update_sort
...
class DeleteViewSortActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, view_sort: ViewSort):
        ...
        See jadawel.contrib.database.views.handler.ViewHandler.delete_sort
...
class OrderViewsActionType(UndoableActionType):
    ...
    def do(
        ...
        See jadawel.contrib.views.handler.ViewsHandler.order_views for further details.
...
class UpdateViewFieldOptionsActionType(UndoableActionType):
    ...
    def do(
        ...
        See jadawel.contrib.database.views.handler.ViewHandler.update_field_options
        for more.
...
class RotateViewSlugActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, view: View) -> View:
        ...
        See jadawel.contrib.database.views.handler.ViewHandler.rotate_slug for more.
...
class UpdateViewActionType(UndoableActionType):
    ...
    def do(
        ...
        **data,
        ...
        See jadawel.contrib.database.views.handler.ViewHandler.update_view for more.
...
class CreateViewActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, table: Table, type_name: str, **kwargs) -> View:
        ...
        See jadawel.contrib.views.handler.ViewsHandler.create_view for further details.
...
class DeleteViewActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, view: View):
        ...
        See jadawel.contrib.views.handler.ViewsHandler.delete_view for further details.
...
class CreateDecorationActionType(UndoableActionType):
    ...
    def do(
        ...
        See jadawel.contrib.decorations.handler.DecorationsHandler.create_decoration
        for further details.
...
class UpdateDecorationActionType(UndoableActionType):
    ...
    def do(
        ...
        See jadawel.contrib.decorations.handler.DecorationsHandler.update_decoration
        for further details.
...
class DeleteDecorationActionType(UndoableActionType):
    ...
    def do(cls, view_decoration: ViewDecoration, user: AbstractUser):
        ...
        See jadawel.contrib.decorations.handler.DecorationsHandler.delete_decoration
        for further details.
...
class CreateViewGroupByActionType(UndoableActionType):
    ...
    def do(
        ...
        See jadawel.contrib.database.views.handler.ViewHandler.create_group
...
class UpdateViewGroupByActionType(UndoableActionType):
    ...
    def do(
        ...
        See jadawel.contrib.database.views.handler.ViewHandler.update_group
...
class DeleteViewGroupByActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, view_group_by: ViewGroupBy):
        ...
        See jadawel.contrib.database.views.handler.ViewHandler.delete_group
...
class EditFormRowActionType(ActionType):
    type = "edit_form_row"
    description = ActionTypeDescription(
        _("Edit form row"),
        _("Row (%(row_id)s) updated via form edit"),
        VIEW_ACTION_CONTEXT,
    )
    analytics_params = [
        "view_id",
    ...
    def do(
        ...
        """
        Updates a row via a form view edit link that's generated by the form view
        edit link field type.
        ...
        :param field_options: The form view field options. If not provided, the
            field options will be fetched from the form view.
