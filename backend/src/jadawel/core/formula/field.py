...
class FormulaField(models.TextField):
    ...
    def _deserialize_jadawel_object(
        ...
        representing a Jadawel formula object. If the value is not a valid JSON string
        representing a Jadawel formula object, returns None.

        :param value: The value from the database to deserialize.
        :return: A dictionary representing the Jadawel formula object, or None if
