...
from jadawel.core.duration import is_valid_duration_format
from jadawel.core.formula.utils.date import (
...
class ThousandSeparatorJadawelRuntimeFormulaArgumentType(
    JadawelRuntimeFormulaArgumentType
):
    def test(self, value):
        if not isinstance(value, str):
...
class DecimalSeparatorJadawelRuntimeFormulaArgumentType(
    JadawelRuntimeFormulaArgumentType
):
    def test(self, value):
        if not isinstance(value, str):
...
class TimedeltaJadawelRuntimeFormulaArgumentType(JadawelRuntimeFormulaArgumentType):
    def test(self, value):
...
class DurationJadawelRuntimeFormulaArgumentType(JadawelRuntimeFormulaArgumentType):
    def test(self, value):
        try:
...
class DurationFormatJadawelRuntimeFormulaArgumentType(
    JadawelRuntimeFormulaArgumentType
):
    def test(self, value):
