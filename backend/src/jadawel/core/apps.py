...
from jadawel.cachalot_patch import clear_cachalot_cache
from jadawel.core.sentry import patch_user_model_str
...
class CoreConfig(AppConfig):
    ...
    def ready(self):
        ...
        from jadawel.core.fields import LenientDecimalField
        ...
        from jadawel.core.trash.trash_types import (
        ...
        from jadawel.core.actions import (
        ...
        from jadawel.core.snapshots.actions import (
        ...
        from jadawel.core.trash.actions import (
        ...
        from jadawel.core.trash.registries import (
        ...
        from jadawel.core.user.actions import (
        ...
        from jadawel.api.notifications.user_data_types import (
            UnreadUserNotificationsCountPermissionsDataType,
        )
        from jadawel.api.user.registries import user_data_registry
        from jadawel.api.user.user_data_types import GlobalPermissionsDataType
        ...
        from jadawel.core.registries import auth_provider_type_registry

        auth_provider_type_registry.register(PasswordAuthProviderType())

        from jadawel.core.two_factor_auth.registries import (
        ...
        from jadawel.core.captcha.provider_types import (
            CloudflareTurnstileCaptchaProviderType,
        )
        from jadawel.core.captcha.registries import captcha_provider_registry

        captcha_provider_registry.register(CloudflareTurnstileCaptchaProviderType())

        from jadawel.api.settings.registries import settings_data_registry
        from jadawel.core.captcha.settings_data_type import CaptchaSettingsDataType
        ...
        import jadawel.core.posthog  # noqa: F403, F401
    ...
    def _setup_health_checks(self):
        ...
        from jadawel.core.integrations.object_scopes import IntegrationObjectScopeType
        from jadawel.core.registries import (
            object_scope_type_registry,
            operation_type_registry,
        )
        ...
        from jadawel.core.integrations.operations import (
        ...
        from jadawel.core.user_sources.object_scopes import UserSourceObjectScopeType

        object_scope_type_registry.register(UserSourceObjectScopeType())

        from jadawel.core.user_sources.operations import (
        ...
        from jadawel.core.mcp.operations import (
        ...
        import jadawel.core.import_export.tasks  # noqa: F403, F401
        import jadawel.core.integrations.receivers  # noqa: F403, F401
        ...
        from jadawel.core.pgvector import try_migrate_vector_fields
...
def sync_operations_after_migrate(sender, **kwargs):
    ...
    if apps is not None:
        try:
            ...
            from jadawel.core.registries import operation_type_registry
