...
from jadawel.contrib.database.table.models import TableModelQuerySet
...
from jadawel.test_utils.helpers import register_instance_temporarily
...
def test_list_rows_with_limit_without_count(api_client, data_fixture):
    ...
    with patch(
        "jadawel.contrib.database.table.models.TableModelQuerySet",
