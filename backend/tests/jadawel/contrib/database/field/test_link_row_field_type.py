...
from jadawel.contrib.database.fields.models import (
    Field,
    LinkRowField,
    SelectOption,
    TextField,
...
from jadawel.contrib.database.fields.utils.duration import H_M_S
...
from jadawel.core.models import TrashEntry, WorkspaceUser
...
@pytest.mark.django_db
@pytest.mark.field_link_row
@patch("jadawel.contrib.database.fields.receivers.field_updated.send")
