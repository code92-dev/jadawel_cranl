...
from jadawel.contrib.builder.builder_beta_init_application import (
...
from jadawel.contrib.builder.workflow_actions.handler import (
...
def test_builder_application_doesnt_import_favicon_file(data_fixture):
    ...
    with patch(
        "jadawel.contrib.builder.application_types.UserFileHandler"
    ) as mocked_handler:
        builder = BuilderApplicationType().import_serialized(
            workspace, serialized_values, config, {}
        )
